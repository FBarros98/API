...
def request_page():
    ...
    data_set = {'Page': 'Request', 'Message': f'Successfully got the request for {user_query}', 'Timestamp':data} # Conjunto de dados que é um dicionário com todas as infos que a API deve retornar
    json_dump = json.dumps(data_set) #Converte as informações em um json
